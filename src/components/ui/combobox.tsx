...
function ComboboxChip({
    ...
    return (
        <ComboboxPrimitive.Chip
            ...
            className={cn(
                "bg-muted text-foreground flex h-6 w-fit items-center justify-center gap-1 rounded-sm px-1.5 text-xs font-medium whitespace-nowrap has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0",
                className,
            )}
            {...props}
        >
            ...
            {showRemove && (
                <ComboboxPrimitive.ChipRemove
                    ...
                    className="hover:bg-accent focus-visible:ring-ring/50 -ml-1 flex size-5 shrink-0 cursor-pointer items-center justify-center rounded-sm opacity-50 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:outline-none"
